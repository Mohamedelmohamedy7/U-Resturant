        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.center,
           children: [
            ...
            Padding(
              padding:   EdgeInsets.only(left: MediaQuery.of(context).size.width*.12,top: 40),
              child:const Text("No Meals Added ..!",style: TextStyle(
                color: primaryColor,
          ...
          child: Padding(
            padding:
              EdgeInsets.only(top: height*.03, right: width*0.035, left: width*0.035, bottom: height*.02),
            child: Container(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  CustemText(
                                    text: " ${_meal![index].calories} Calories",
                                    color: primaryColor,
                                    fontsize: 13,
                              ...
                              Padding(
                                padding:   EdgeInsets.only(
                                    bottom: height*.07, left: width*0.01),
                                child: IconButton(
                                  onPressed: () {
